...
export function ProfilePage() {
  ...
  if (!isRegistered) return <div className="section-enter space-y-5"><RoleSummary name="Guest Host" workspace={workspace.name} role={workspace.role} detail="Anonymous session" /><EmptyState title="Guest identity" description="Create a SevenTwo account, then use a Player invite to access a persistent poker profile." action={<Link to="/">Dashboard</Link>} /></div>
